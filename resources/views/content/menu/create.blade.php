...
@section('title', 'Nuevo Platillo - Menú')
...
<form action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
      <h4 class="mb-1">Nuevo Platillo</h4>
      <p class="mb-0">Completa los datos del platillo para el menú</p>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-8">
        ...
        <div class="card-body">
          ...
          <div class="mb-6">
            ...
            <textarea class="form-control @error('descripcion') is-invalid @enderror"
                      ...
                      name="descripcion"
                      rows="4"
                      placeholder="Descripción del platillo (mínimo 10 caracteres)">{{ old('descripcion') }}</textarea>
            @error('descripcion')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          <div class="mb-3">
            <label class="form-label" for="menu-imagen">Imagen (JPG / PNG, máx. 2 MB)</label>
            <input type="file"
