...
@section('title', 'Platillos más vendidos - SGR')
...
<div class="d-flex justify-content-between align-items-center mb-6 flex-wrap gap-3">
  <div>
    <h4 class="mb-1">Platillos más vendidos</h4>
    <p class="mb-0"><a href="{{ route('reports.index') }}">Reportes</a> / Platillos</p>
  </div>
  <div class="d-flex gap-2">
    <a href="{{ route('reports.top-dishes', array_merge(request()->query(), ['export' => 'excel'])) }}" class="btn btn-label-success">
      <i class="icon-base ti tabler-file-spreadsheet me-1"></i> Excel
    </a>
    <a href="{{ route('reports.top-dishes', array_merge(request()->query(), ['export' => 'pdf'])) }}" class="btn btn-label-danger">
...
<div class="card mb-4">
  <div class="card-body">
    <form method="GET" action="{{ route('reports.top-dishes') }}" class="row g-3 align-items-end">
      <div class="col-md-4">
...
<div class="card">
  <div class="card-datatable">
    <table class="table table-bordered report-table" id="dishesTable">
