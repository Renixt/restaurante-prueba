...
@section('title', 'Nuevo Pedido - SGR')
...
<form action="{{ route('purchase-orders.store') }}" method="POST" id="po-form">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div>
      ...
      <p class="mb-0">Crea un pedido de insumos a proveedor</p>
    </div>
    <div class="d-flex gap-3">
      <a href="{{ route('purchase-orders.index') }}" class="btn btn-label-secondary">Cancelar</a>
      <button type="submit" class="btn btn-primary" id="btn-submit-po">
        <i class="icon-base ti tabler-check me-1"></i>Crear Pedido
      </button>
    </div>
  </div>
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          <textarea name="notes" class="form-control" rows="3"
                    placeholder="Indicaciones para el proveedor...">{{ old('notes') }}</textarea>
        </div>
      </div>
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          ...
          <div class="mb-4">
            ...
            <input type="date" id="po-delivery" name="delivery_date"
                   class="form-control" value="{{ old('delivery_date') }}" min="{{ date('Y-m-d') }}" />
          </div>
          ...
          <button type="submit" class="btn btn-primary w-100">
            <i class="icon-base ti tabler-check me-1"></i>Confirmar Pedido
          </button>
        </div>
      </div>
    </div>
